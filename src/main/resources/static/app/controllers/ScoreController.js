var ScoreController = function($scope,atmosphereService) {
    ...
    request.onMessage = function(response){
        console.log("fffffffffffffffffffffppp");
        ...
        try{
            ...
            if(!$scope.model.logged && $scope.model.name)
             ...
             //   var date = typeof(message.time) === 'string' ? parseInt(message.time) : message.time;
               ...
               // $scope.model.messages.push({id: message.id, description: message.description});
                $scope.model.messages =message;
            }
        }catch(e){
